...
namespace Guardrails
{
    ...
    namespace PassiveScaling
    {
        ...
        void scale_fermion_fields_down(half3 position, half scale_reduction_factor, FermionLatticeBuffer lattice_buffer)
        {
            half scaling_factor = 1 - scale_reduction_factor;
        ...
        // • Reads directly from the simulation's lattice buffers
        // • Writes directly to the simulation's lattice buffers
        void scale_gauge_fields_down(half3 position, half scale_reduction_factor, GaugeLatticeBuffer lattice_buffer)
        {
            half scaling_factor = 1 - scale_reduction_factor;
