...
namespace GaugeEnergyComputations
{
    ...
    half compute_energy_density(FieldStrengthTensor field_strength_tensor) {
        half total_energy = 0;
    ...
    void compute_energy_density(FieldStrengthTensor field_strength_tensor, out half energy_densities[12]) {
    ...
    half compute_energy_density(GaugeSymmetriesVectorPack electric_field_strength, GaugeSymmetriesVectorPack magnetic_field_strength) {
        half total_energy = 0;
