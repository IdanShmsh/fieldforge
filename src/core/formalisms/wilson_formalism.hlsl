...
namespace WilsonFormalism
{
    ...
    void parallel_transport_fermion_u1(FermionFieldState fermion_state, GaugeSymmetriesVectorPack gauge_potentials, uint axis, half u1_gauge_coupling_constant, out FermionFieldState transported_fermion_state)
    {
        half theta = u1_gauge_coupling_constant * gauge_potentials[0][axis];
    ...
    void parallel_transport_fermion_su2(FermionFieldState fermion_state, FermionFieldState weak_partner_state, GaugeSymmetriesVectorPack gauge_potentials, uint axis, half su2_gauge_coupling_constant, bool weak_doublet_index, out FermionFieldState transported_fermion_state)
    {
    ...
    void parallel_transport_fermion_su3(FermionFieldState fermion_state, GaugeSymmetriesVectorPack gauge_potentials, uint axis, half su3_gauge_coupling_constant, out FermionFieldState transported_fermion_state)
    {
    ...
    // the gauge fields with the given potentials and coupling constants.
    void backward_parallel_transport_fermion(FermionFieldState fermion_state, FermionFieldState weak_partner_state, GaugeSymmetriesVectorPack gauge_potentials, uint axis, half3 gaugeCouplingConstants, bool weakDoubletIndex, out FermionFieldState transportedSpinor)
    {
