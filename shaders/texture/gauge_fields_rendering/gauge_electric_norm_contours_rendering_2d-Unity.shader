...
/// -----------------------------------------------------------------------------------------------
/// This pipeline operation renders contour lines of the electric strength fields' norm within the xy-plane 
...
Shader "Custom/gauge_electric_norm_contours_rendering_2d"
{
    SubShader
    {
        Tags
        ...
        Pass
        {
            ...
            half4 frag(v2f i) : SV_Target
            {
                ...
                color += GaugeRendering::RenderGaugeVectorsRGBContours::get_gauge_vectors_norm_contours_color_at_position(rend_electric_strengths_lattice_buffer, position, granularity, definition);
