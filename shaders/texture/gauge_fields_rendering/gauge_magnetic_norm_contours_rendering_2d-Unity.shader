...
/// -----------------------------------------------------------------------------------------------
/// This pipeline operation renders contour lines of the magnetic strength fields' norm within the xy-plane 
...
Shader "Custom/gauge_magnetic_norm_contours_rendering_2d"
{
    SubShader
    {
        Tags
        ...
        Pass
        {
            ...
            half4 frag(v2f i) : SV_Target
            {
                ...
                color += GaugeRendering::RenderGaugeVectorsRGBContours::get_gauge_vectors_norm_contours_color_at_position(rend_magnetic_strengths_lattice_buffer, position, granularity, definition);
