...
/// -----------------------------------------------------------------------------------------------
/// This pipeline operation renders contour lines of the magnetic strength fields' components within the xy-plane 
...
Shader "Custom/gauge_magnetic_component_contours_rendering_2d"
{
    SubShader
    {
        Tags
