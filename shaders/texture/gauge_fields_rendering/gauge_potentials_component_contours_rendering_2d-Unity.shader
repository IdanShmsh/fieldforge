...
/// -----------------------------------------------------------------------------------------------
/// This pipeline operation renders contour lines of the potentials strength fields' components within the xy-plane 
...
Shader "Custom/gauge_potentials_component_contours_rendering_2d"
{
    SubShader
    {
        Tags
        ...
        Pass
        {
            ...
            half4 frag(v2f i) : SV_Target
            {
                ...
                color += GaugeRendering::RenderGaugeVectorsRGBContours::get_gauge_vectors_rgb_contours_color_at_position(rend_gauge_potentials_lattice_buffer, position, granularity, definition);
