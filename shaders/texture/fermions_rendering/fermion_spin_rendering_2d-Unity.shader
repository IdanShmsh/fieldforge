    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag(v2f i) : SV_Target
            {
                ...
                color += FermionFieldColoring::compute_fermion_fields_spin_dial_color(position, prev_fermions_lattice_buffer);
                color += FermionFieldColoring::compute_fermion_fields_spin_dial_color(position, crnt_fermions_lattice_buffer);
                color[3] = 1;
                return color;
            }
            ENDCG
