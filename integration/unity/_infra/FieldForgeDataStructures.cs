...
namespace FieldForge
{
    ...
    public struct SpinorFieldChangeInformation
    {
        public bool activeFlag;
        public FermionFieldState state;
        public uint fieldIndex;
        public float3 origin;
        public float3 evolutionVector;
        public float majorSD;
        public float minorSD;
    }

    public struct GaugeFieldsChangeInformation
    {
        public bool activeFlag;
        public GaugeSymmetriesVectorPack state;
        public float3 origin;
        public float3 evolutionVector;
        public float majorSD;
        public float minorSD;
